	...
	<?php
		...
		if(isset($_GET['cart_id'])):
			...
			if($cart != null):
				...
				$total = 0;
	?>
	<div class="text-center" id="back-button" style="padding:20px;"><a href="account.php" class="btn btn-black"><i class="fa fa-arrow-left"></i> Back</a> <button type="button" id="print-btn" class="btn btn-success">Print <i class="fa fa-print"></i></button> </div>
